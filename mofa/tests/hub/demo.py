...
# from mofa.run.run import run_dspy_agent, run_crewai_agent
...
# yaml_file_path = f'/Users/chenzi/project/zcbc/Moxin-App-Engine/mofa/agent-hub/content-evaluation/content_evaluation/content_evaluation_agent.yml'
...
# yaml_file_path = f'/Users/chenzi/project/zcbc/Moxin-App-Engine/mofa/agent-hub/beauty-context/beauty_context/beauty_context_agent.yml'
# inputs = load_agent_config(yaml_file_path)
